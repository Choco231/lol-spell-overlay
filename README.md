...
이미 설치가 끝난 컴퓨터에서는 아래 파일을 더블클릭하면 됩니다. 서버 주소는 기본값으로 들어가 있으므로 Enter를 누르고, 방 번호 `1`, `2`, `3` 중 하나를 입력하면 됩니다.
...
TOP 라인에서만 스펠 변경창에 TOP 포지션 아이콘이 추가로 보입니다. 이 아이콘은 퀘스트 완료 후 텔레포트를 들지 않았을 때 생기는 추가 텔레포트입니다. 기본 쿨타임은 420초로 추적합니다.
