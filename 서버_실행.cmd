...
powershell -NoProfile -ExecutionPolicy Bypass -Command ^
  "$cfg = [ordered]@{ enabled = $true; serverUrl = 'http://127.0.0.1:17898'; canControl = $true }; $cfg | ConvertTo-Json | Set-Content -LiteralPath 'sync-client-config.json' -Encoding UTF8"
